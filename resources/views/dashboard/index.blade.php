            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ $kategori->count() }}</h2>
                            <span class="text-white fs-18">Kategori</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ $pelanggaran->count() }}</h2>
                            <span class="text-white fs-18">Pelanggaran</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ $siswa->count() }}</h2>
                            <span class="text-white fs-18">Siswa</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    var dataDashboard = {!! json_encode($dataDashboard) !!};
</script>
