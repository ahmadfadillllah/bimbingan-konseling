                                    ...
                                    <div id="about-me" class="tab-pane fade pt-3 active show">
                                        <div class="profile-personal-info">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-sm-9 col-7"><span>{{ Auth::user()->nik }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                    <h5 class="f-w-500">Mata Pelajaran <span class="pull-end">:</span>
                                                    </h5>
                                                </div>
                                                <div class="col-sm-9 col-7"><span>{{ Auth::user()->mata_pelajaran }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="settings-form">
                                                ...
                                                <form action="{{ route('profile.update') }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" value="{{ Auth::user()->nik }}" name="nik" class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" value="{{ Auth::user()->mata_pelajaran }}" name="mata_pelajaran" class="form-control">
                                                    </div>
